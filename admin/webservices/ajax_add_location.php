<?php
	...
	if(isset($_REQUEST['action']) && $_REQUEST['action'] == 'add_blogs'){
		//$added_by = $_SESSION['user_id'];
			...
			$location_link = $_REQUEST['location_link'];
			...
			//$url = seo_url($title);
	    	$sql_insert_blogs = "INSERT INTO location(project_id,location_image,location_desc,location_glink) VALUES ('".$product_id."','".$blogs_main_image."','".$location_desc."','".$location_link."')";
