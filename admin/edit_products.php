...
<?php
  ...
  /*  error_reporting(0);
    ...
    $get_blogs = "SELECT * FROM projects WHERE id=".$_GET['id'];
                	...
                	<form id="manage_blogsFormData" name="manage_blogsFormData" method="post">
	                	<div class="col-lg-12">
	                		...
	                		<div class="form-group">
	                			...
	                			<input type="text" class="form-control" name="project_name" id="project_name" value="<?php echo $result_get_blogs[0]['project_name'];?>">
	                		</div>
                            <div class="form-group">
                                <label>Project Category</label>
                                <input type="text" class="form-control" name="project_category" id="project_category" value="<?php echo $result_get_blogs[0]['project_category'];?>">
                            </div>
                            <div class="form-group">
                                <label>Project Quote</label>
                                <input type="text" class="form-control" name="project_quote" id="project_quote" value="<?php echo $result_get_blogs[0]['project_quote'];?>">
                            </div>
