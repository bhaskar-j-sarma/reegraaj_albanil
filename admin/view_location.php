        ...
        <div class="col-lg-12">
            <div class="hpanel">
                <div class="panel-body">
                    <h3>View Location</h3> 
                    <button type="button" id="delete_images" class="btn btn-danger">Delete Locations</button>    
                    <a href="add_location.php?g_id=<?php echo $get_id; ?>" class="btn btn-info" role="button">Add Location</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        ...
                        <tbody style="font-size: 14px;">
                            <?php
                            $get_id = $_GET['id'];
                            $sql=$image_list->get_location($get_id);
                            $c = 0;
                            ...
                            <td><?php echo ++$c; ?></td>
                            <td><?php echo $row['location_image'] ?></td>  
                            <td><?php echo $row['location_desc'] ?></td>                      
                            <td><?php echo $row['location_glink'] ?></td>                      
                            </tr>
                            <?php } ?>
                        </tbody>
                        </table>
