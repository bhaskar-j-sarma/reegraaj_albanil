        ...
        <div class="col-lg-12">
            <div class="hpanel">
                <div class="panel-body">
                    ...
                    <button type="button" id="delete_images" class="btn btn-danger">Delete Amenities</button>    
                    <a href="add_amenities.php?g_id=<?php echo $get_id; ?>" class="btn btn-info" role="button">Add Amenities</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <thead style="font-size: 13px;">
                            <tr>
                                ...
                                <th>Sr No</th>
                                <th>Amenities Tittle</th>
                            </tr>
                        </thead>
                        <tbody style="font-size: 14px;">
                            <?php
                            $get_id = $_GET['id'];
                            $sql=$image_list->get_amenities($get_id);
                            $c = 0;
                            ...
                            <td><?php echo ++$c; ?></td>
                            <td><?php echo $row['amenities_title'] ?></td>  
                            </tr>
                            <?php } ?>
                        </tbody>
                        </table>
