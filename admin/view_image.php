        ...
        <div class="col-lg-12">
            <div class="hpanel">
                <div class="panel-body">
                    <h3>View Images</h3> 
                    <button type="button" id="delete_images" class="btn btn-danger">Delete Images</button>    
                    <a href="add_image.php?g_id=<?php echo $get_id; ?>" class="btn btn-info" role="button">Add Images</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        ...
                        <tbody style="font-size: 14px;">
                            <?php
                            $get_id = $_GET['id'];
                            $sql=$image_list->get_images($get_id);
                            $c = 0;
