...
<script type="text/javascript" src="js/add_features.js"></script>
                ...
                <div class="panel-body">
                    <form id="blogsFormData"  name ="blogsFormData" enctype="multipart/form-data" method="post">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                <label>Feature Tittle</label>
                                <input type="text" class="form-control" id="feature_tittle" name="feature_tittle">
                            </div>
                            <div class="form-group">
