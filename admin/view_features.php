        ...
        <div class="col-lg-12">
            <div class="hpanel">
                <div class="panel-body">
                    <h3>View Features</h3> 
                    <button type="button" id="delete_images" class="btn btn-danger">Delete Features</button>    
                    <a href="add_features.php?g_id=<?php echo $get_id; ?>" class="btn btn-info" role="button">Add Features</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        ...
                        <tbody style="font-size: 14px;">
                            <?php
                            $get_id = $_GET['id'];
                            $sql=$image_list->get_features($get_id);
                            $c = 0;
                            ...
                            <td><?php echo $row['feature_tittle'] ?></td>                      
                            </tr>
                            <?php } ?>
                        </tbody>
                        </table>
