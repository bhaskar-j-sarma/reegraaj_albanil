...
<script type="text/javascript" src="js/add_architect.js"></script>
                    ...
                    <form id="blogsFormData"  name ="blogsFormData" enctype="multipart/form-data" method="post">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="architect_name" name="architect_name">
                            </div>
                            <div class="form-group">
                                <label>Architect Message</label>
                                <input type="text" class="form-control" id="architect_message" name="architect_message">
                            </div>
                            <div class="form-group">
